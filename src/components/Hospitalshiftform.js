...
const Hospitalshiftform = (props) => {

  const snl = props.location.state ? props.location.state.formds : []
  ...
  const [formds,setFormd] = useState(initialState.formds)
...
export default Hospitalshiftform;